<?php
  ...
  $sorgu=$vt->prepare("SELECT * FROM teklif");
  $sorgu->execute();
  $teklif=$sorgu->fetchAll(PDO::FETCH_OBJ);
            ...
            <div class="container" id="plan">
                <div class="row">
                    <div class="col"> 
                        ...
                        <img src="<?= $u->teklif_resim ?>" class="img-thumbnail"> </a>
                    </div>
                    <div class="col-5">
                      <h2 style="color: #e60000;"><?= $u->teklf_isim ?> <?= $u->teklif_soyisim ?></h2>
                      <p> <?= $u->teklif_aciklama ?></p>
                      
                        <p><b>Alinan İl :</b> <?= $u->teklif_alinan_il ?></p>
                        <p><b>Götürülcek İl :</b> <?= $u->teklif_alinan_il ?></p>
                        <p><b>Asansör Bilgisi :</b> <?= $u->teklif_asansor ?></p>
                        <p><b>Açık Adres :</b> <?= $u->teklif_adres ?></p>
                    </div>
                    <div class="col" id="button">

                      <a href="teklifver.php" type="button" class="btn btn-outline-danger btn-lg">Fiyat Teklifi Ver</a><br><br>

        

                        <h6>Alınan Kat : <?= $u->teklif_alinan_kat ?></h6>
                        <h6>Götürülcek Kat : <?= $u->teklif_goturulcek_kat ?></h6>
                        <h6>Oda Sayısı : <?= $u->teklif_oda ?></h6>
                    </div>
                </div>
            </div>
    <?php } ?>
