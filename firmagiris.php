...
<?php
  ...
  if($_POST)
  {
    ...
    $query  = mysqli_query($conn ,"SELECT * FROM `firmalar` WHERE firma_mail='$name' && firma_password='$pass'");
    $say = mysqli_num_rows($query);
    ...
    if($say){
        ...
        print '<h1>Hoş geldiniz</h1>'.$name;
       
    }
    else{
      echo "<h1>Kullanıcı adı veya şifre hatalı</h1>";
       echo 'üye değilseniz üye olmak için <a href="firmagiris.php">Tıklayın</a>';
    }
...
<body>
    ...
    <div id="logreg-forms" style="margin-top: 100px;">
        ...
        <form class="form-signin" method="POST" action="firmagiris.php">

            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Firma Giriş Yap</h1>
