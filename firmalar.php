...
<body>
    ...
    <?php 
        foreach ($firmalar as $u) { ?>       
            <div class="container" id="plan">
                <div class="row">
                    <div class="col"> 
                   
                        <img src="<?= $u->resim ?>" class="img-thumbnail"> </a>
                    </div>
                    <div class="col-5">
                      <h2 style="color: #e60000;"><?= $u->firma_unvani ?></h2>
                      <p><?= $u->message ?></p>
                    </div>
                    <div class="col" id="button">

                      <a href="fiyatteklif.php" type="button" class="btn btn-outline-danger btn-lg">Fiyat Teklfi Al</a><br><br>
